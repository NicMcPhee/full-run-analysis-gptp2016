...
\hline
& & & \texttt{(tag\_exec\_471} \\ 
& & & \texttt{ integer\_fromboolean} \\ 
\texttt{(\textbackslash space} & \; 0 & \texttt{(\textbackslash space} & \\ 
\texttt{ \textbackslash newline} & \; 1 & \texttt{ \textbackslash newline} & \\
& \; 2 & \texttt{ exec\_dup} & \\
\texttt{ in1} & \; 3 & \texttt{ in1} & \texttt{ in1} \\
\texttt{ string\_replacechar} & \; 4 & \texttt{ string\_replacechar} & \emph{\texttt{ string\_stackdepth}} \\
\texttt{ print\_string} & \; 5 & \texttt{ print\_string} & \texttt{ print\_string} \\
& \; 6 & \texttt{ exec\_dup} & \texttt{ exec\_dup} \\
%1 & • & • & • & • & • \\ 
%2 & • & • & • & • & • \\ 
%3 & • & • & • & • & • \\ 
%4 & • & • & • & • & • \\ 
