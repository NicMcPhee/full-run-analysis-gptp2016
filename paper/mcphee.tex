...
Unlike previous versions of PushGP, Clojush has recently changed to not evolve 
...
Push implements a method of automatic simplification, which takes a program and 
...
instruction caused the printed output to always have an error of one because
of that \texttt{print\_newline}, and its removal led to 100 errors changing
...
all appear much later in the genome, from gene 107 to gene 175. As consequence
we'll trace these two groups one at a time.

\subsubsection{Printing: The first five instructions}
\label{sec:Printing}
...
\subsubsection{Returning: The last four instructions}
\label{sec:Returning}
...
\paragraph{4:772 and the carriers of \texttt{in1}}
\label{sec:4:772}
...
\paragraph{4:425, 4:107, and multiple blocks}
\label{sec:4:425}

3:122 contains a block of 25 genes % genes 77 to 101
...
\paragraph{4:897 and the carriers of \texttt{string\_length}}
\label{sec:4:897}
...
\paragraph{19:554 and the final adjustments}
