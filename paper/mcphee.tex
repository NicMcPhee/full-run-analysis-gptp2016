...
and child genomes. The graph database tools then make it easy to trace lineages and extract the subgraphs visualized in the next section. With access to all of the data in an organized fashion we 
can pull subgraphs or ancestry trees of individuals that found a solution from 
the database and create visualizations like the ones in this paper. For these visualizations we used the
