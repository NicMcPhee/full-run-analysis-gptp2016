...
graph. The DL-distance between 18:937 and 19:554 is 55, however,
...
from 1 to 0 (i.e., correct on that test case), where it two it went the other way
...
\todo{Mitchell (or Nic) will add text to this so we don't just have the big table.}
