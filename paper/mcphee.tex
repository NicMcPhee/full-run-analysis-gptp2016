...
\abstract{
In genetic programming runs there is frequently a great deal of data to work with.
This data is often put aside in favor of solely looking at the produced result.
In this research, the goal was to examine a genetic programming run and trace 
back from the solution to determine how it was derived. 
To visualize genetic programming runs in a more organized fashion, the ancestry tree is extracted from the 
solution(s) up to their relatives in the initial random population. For an even closer look, the solution is analyzed for instructions and a genetic ancestry tree is made of those who have contributed genetic information (or instructions) to the solution. In this trace of genetic information we were able to identify trends at important moments and other interesting aspects.
}
...
mutating a \emph{single} instruction. \todo{Nic is this what this should be saying? -MC} The mutation that led to 20:435 
...
and that none of the genetic operators was particularly over- or 
...
and 5 had DL-distances of 0 (so the child was an exact copy of the parent).
...
contribute any of the nine key instructions to 3:273, where 2:779 contributed
...
Not all alternation events in Figure~\ref{fig:run0Filtered} could be seen as
effectively mutation events, however. The construction of 15:801, for example,
...
In the recombination this gene wasn't passed on to 15:801, which led to an
...
show the progression of a run and highlight important moments. These moments included individuals such as 3:122 and 15:801 who were interesting in how they altered the state of play. By tracing through the genetic ancestry tree we were able to learn more about how both alternation and mutation played a role in finding a solution.

The next step in this research of tracing runs is automating the process of comparing individuals, especially their genomes. With a 20 generation run, there was a manageable amount of information to process by hand. However, with a run that may go for 100 generations or more, the comparisons would quickly get out of hand and become very time consuming. Another aspect we plan to modify is the tracking of instructions. As said previously, the instructions of the solution were traced by hand. If we were to assign IDs to instructions we would be able to trace their ancestry throughout the generations much more easily.
% Not quite sure if want to say this since we've said the genetic ancestry tree was developed in this reseach.
%Removal of crud in programs is also important and should be looked at more


The prevalence of alternation events in the gene ancestry graph that were in 
fact just gene deletions or duplications suggests that it might
be valuable to include deletion and replication mutations as stand-alone
operators, instead of requiring that happen via lucky alternations.
