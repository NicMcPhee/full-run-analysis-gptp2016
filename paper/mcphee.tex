...
(Put the following in the description of RSWN):
After executing a program, Push takes function return values from the top of the relevant stacks. For example, each program evolved in this run returns the top integer on the integer stack as its output. Push also has the ability to print literals to standard output.
