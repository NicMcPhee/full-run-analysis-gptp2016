...
\begin{itemize}
	\item The usefulness of the graphs
	\item 15:801 is interesting
	\item Tracing lineage of the instructions provides insight into how both alternation and mutation play a role
	\item We need to automate all the crud that was slogged through
	\item Removal of crud in programs is also important and should be looked at more
	\item Label instructions in future runs to be able to track their exact parents
\end{itemize}
