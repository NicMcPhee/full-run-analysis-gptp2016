...
Previous work~\citep{McPhee:2015:GPTP, donatuccianalysis, Burlacu:2013:GECCOcomp:new,burlacu2015effectiveness,Burlacu:CIEES:2015,burlacu2015building, kuber2014ancestral} has
...
\citep{Helmuth:2016:GPTP}. Each \textit{Plush (\textbf{L}inear 
...
original program \citep{Spector:2014:GECCOcomp}. This can dramatically simplify programs, reducing, for example, one program from 194 instructions down to 9 instructions.
