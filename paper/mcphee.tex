...
\texttt{print\_newline} & 8 & \texttt{string\_eq} & \texttt{exec\_s} \\ 
& 9 &  & \texttt{exec\_dup} \\ 
& 10 &  & \texttt{exec\_rot} \\ 
& 11 &  & \texttt{string\_exec string\_fromboolean} \\ 
& 12 &  & \texttt{char\_eq} \\ 
& 13 & & \texttt{string\_emptystring boolean\_stackdepth in1 integer\_gt} \\ 
& 14 &  & \texttt{string\_emptystring} \\ 
& 15 & \texttt{\textbackslash space} & \texttt{\textbackslash space} \\ 
& 16 & \texttt{string\_dup} & \texttt{string\_dup} \\ 
& 17 & \texttt{string\_removechar} & \texttt{string\_removechar} \\ 
& 18 & \texttt{string\_rot} & \texttt{boolean\_pop} \\ 
& 19 &   & \texttt{in1} \\ 
